...
// Performs the actions of the adventurer card
...
// Performs the actions of the smithy card
int SmithyAction(struct gameState *state, int handPos)
{
	int currentPlayer = whoseTurn(state);
...
// Performs the actions of the village card
int VillageAction(struct gameState *state, int handPos)
{
	int currentPlayer = whoseTurn(state);
...
// Performs the actions of the sea hag card
int SeaHagAction(struct gameState *state)
{
	int currentPlayer = whoseTurn(state);
...
// Performs the actions of the outpost card
int OutpostAction(struct gameState *state, int handPos)
{
	int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case smithy:
		return SmithyAction(state, handPos);
    ...
    case outpost:
		return OutpostAction(state, handPos);
